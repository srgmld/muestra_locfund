...
Este reporte es el resultado de la implementación de herramientas y procesos de ciencia de datos. El trabajo descrito y transmitido en este reporte se realiza a través de un código en lenguaje de programación R.

Este tipo de herramientas y procedimientos ofrecen una variedad de beneficios en todo el proceso de trabajo con datos, desde la automatización en la manipulación y manejo general de datos hasta el desarrollo de diversas herramientas y alternativas de visualización y comunicación de datos.

De esta manera es posible, no sólo hacer mas eficientes estos procesos, sino también agregar el valor a la información facilitando el análisis y mejorando la transmisión de resultados.

Cada área y sector es único y diferente, por lo tanto, la manera y el procedimiento de trabajar con datos debe ser desarrollada e implementada de manera específica, cumpliendo con los requerimientos únicos que se puedan tener.
