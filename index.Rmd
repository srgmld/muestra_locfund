...
Mostrar la aplicación de herramientas de ciencia de datos para el manejo, análisis y visualización de datos.
...
Como primer paso, antes de poder generar algún tipo de visualización o análisis, fue necesario estructurar e integrar los datos provistos por el equipo de BI, generando una base de datos única. 
## Datos compartidos
<br>
...
Para la integración de los datos y la información, únicamente se tomó en cuenta los datos crudos/principales. Esto quiere decir que se exluyeron fórmulas y tablas secundarias generadas a partir de los datos crudos/principales.
...
Finalmente se cuenta con una base de datos única general que está compuesta por 24 variables (columnas) y 740 filas (observaciones). De las 24 variables únicamente las variables "hoja" y "libro_excel" son ajenas a los datos originales. Estas dos variables fueron generadas como referencia a la hoja y libro de Excel de donde viene la información de cada fila. 
...
Al pasar el cursor por las lineas se puede ver la fecha del reporte, el valor del portafolio y otra información correspondiente a ete reporte reporte.
...
Ciencia de datos no sólo permite hacer mas eficientes estos procesos, sino también agregar el valor a la información, facilitando el análisis y mejorando la transmisión de comportamientos y resultados.

Cada área y sector es único y diferente, por lo tanto, la manera y el procedimiento de trabajar con datos debe ser desarrollada e implementada de manera específica, adecuandose a las características y cumpliendo con los requerimientos únicos de cada área.

En este ejemplo en particular, se trabajó con información de datos sociales correspondientes a diferentes inversiones en instituciones en latinoamerica. Después de generar una base de datos única se generaron ejemplos de visualización que permiten tener las primeras percepciones o "insights" sobre los datos y el comportamiento de las instituciones.

La ciencia de datos ofrece alternativas para profundizar el análisis de los resultados, objetivos e impacto que se busca. Por ejemplo, se podría analizar el significado del incremento en el porcentaje de clientes mujeres y del sector rural, identificando y sugiriendo nuevas variables e indicadores que midan el impacto en el desarrollo de la economía y el bienestar de la sociedad.

La ciencia de datos permite integrar toda la información para poder implementar modelos y herramientas de machine learning para predecir el impacto y resultados que nuevas decisiones y proyectos puedan generar. Simplemente es cuestión de tener acceso o poder generar los datos e información correcta e implementar las herramientas y conocimiento adecuado.
