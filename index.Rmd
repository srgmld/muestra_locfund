...
La aplicación de herramientas y procedimientos de ciencia de datos ofrecen una variedad de beneficios en todo el proceso de trabajo con datos, desde la automatización en la manipulación y manejo general de datos, el desarrollo de diversas herramientas y alternativas de visualización y comunicación, hasta la aplicación de modelos y técnicas de "machine learning" para la implementación de análisis predictivos.

Ciencia de datos no sólo permite hacer mas eficientes estos procesos, sino también permiten extraer mayor valor y mejoran la interpretación de datos, facilitando el análisis y mejorando la transmisión de tendencias y resultados.
...
En este ejemplo en particular, se trabajó con información de datos sociales correspondientes a diferentes inversiones en instituciones en latinoamerica. Después de generar una base de datos única se produjeron ejemplos de visualización que permiten tener las primeras percepciones o "insights" sobre los datos, el comportamiento y tendencias en las instituciones.
